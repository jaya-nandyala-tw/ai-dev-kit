...
dashboard that reads and writes the real files in this repo and can run the real setup scripts
...
outside this dashboard, it picks that up correctly on the next load. `.onboarding-state.json`
